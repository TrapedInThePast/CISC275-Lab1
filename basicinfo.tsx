...
const yourName : String = "Emma Metcalfe";
let yourPronouns : String = "she/her";
const yourMajor : String = "Computer Science";
let classification : String = "soph";
let oneExcite : String = "I am excited to learn";
let anyConcerns : String = "I am afraid that I will forget something importent.";
let funFact : String = "I am a fan of Technoblade.";